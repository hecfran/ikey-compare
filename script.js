...
$(document).ready(function(){
  $('#imgForm').on('submit', function(e){
    ...
    if (!$("#image1").val() || !$("#image2").val() ){
      ...
      $.ajax({
        //#url: "http://ec2-54-174-202-220.compute-1.amazonaws.com:5000/api/pilotStudy2",
        //url: "https://ec2-54-174-202-220.compute-1.amazonaws.com:5000/api/pilotStudy2",
